view: users {
  ...
  dimension: zoom_app_is_pmi_enabled_c {
    type: yesno
    sql: ${TABLE}.zoom_app_is_pmi_enabled_c ;;
  }

  dimension: zoom_app_login_type_c {
    type: string
    sql: ${TABLE}.zoom_app_login_type_c ;;
  }

  dimension: zoom_app_send_email_to_attendee_c {
    type: yesno
    sql: ${TABLE}.zoom_app_send_email_to_attendee_c ;;
  }
